...
![Qoder screenshot](./metadata/qoder-1.png)

## What is this extension

- Search Qoder Recent Projects
- Use `Open With Qoder` command
- Use `Open New Window` command
- Show Installed Extensions list
- Search & Install Extension from VSCode Marketplace
- Reach and search the Qoder Documentation in an instant right from Raycast without any hassle.
...
This parameter is designed for the Qoder Directory extension.
...
await crossLaunchCommand({
  name: "index",
  extensionName: "qoder-recent-projects",
  ...
  open("raycast://extensions/degouville/qoder-recent-projects");
});
```
