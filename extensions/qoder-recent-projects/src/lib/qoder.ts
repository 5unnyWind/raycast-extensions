...
export function getQoderCLIFilename(): string {
  return "/Applications/Qoder.app/Contents/Resources/app/bin/qoder";
}
...
export function getQoderCLI(): QoderCLI {
  return new QoderCLI(getQoderCLIFilename());
}
