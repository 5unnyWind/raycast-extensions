...
function OpenExtensionInQoderAction(props: { extension: Extension }): JSX.Element {
  return <OpenExtensionByIDInQoderAction extensionID={props.extension.id} />;
}
  ...
  return (
    <List.Item
      ...
      actions={
        <ActionPanel>
          <ActionPanel.Section>
            <OpenExtensionInQoderAction extension={e} />
